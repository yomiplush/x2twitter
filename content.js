(() => {
  ...
  const STRONG_EN = [
    ...
    "strike", "strikes", "tax evasion", "tax fraud", "forgery", "counterfeit",
    "breach of trust", "insider trading", "great reset", "qanon", "q anon", "microchip",
    "microchips", "vaccine", "vaccines", "vaccination", "antivax", "anti-vax", "fake",
    ...
    "drones", "drone strike", "conflict", "conflicts", "hezbollah", "north korea",
    ...
    "outbreak", "evacuation order", "evacuation", "evacuated", "shelter", "downsizing",
    ...
    "scorching heat", "bird flu", "avian flu", "flu", "influenza", "quarreling",
    "bickering", "confrontation", "standoff", "strife", "fight", "fights", "fighting",
