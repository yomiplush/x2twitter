const X2T_I18N = {
  ja: {
    ...
    jevLabel: "Jev AI判定（高精度フィルター）",
    jevKeyLabel: "TypeSafe / OpenRouter APIキー",
    jevKeyPlaceholder: "APIキーを入力",
    jevNote: "投稿の文脈をJevが判断。キーはブラウザ内にのみ保存され、判定時だけ送信されます",
    jevStatusNoKey: "APIキー未設定（正規表現で動作）",
    jevStatusActive: "Jev有効（AI判定）",
    jevStatusOff: "Jev無効（正規表現で動作）",
  ...
  en: {
    ...
    jevLabel: "Jev AI judgment (high-precision filter)",
    jevKeyLabel: "TypeSafe / OpenRouter API key",
    jevKeyPlaceholder: "Enter API key",
    jevNote: "Jev judges posts in context. The key stays in your browser and posts are sent only when judging",
    jevStatusNoKey: "No API key (running on regex)",
    jevStatusActive: "Jev active (AI judgment)",
    jevStatusOff: "Jev off (running on regex)",
