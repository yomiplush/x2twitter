const X2T_I18N = {
  ja: {
    ...
    disasterLabel: "災害支援情報を見ない",
    foodLabel: "グルメ情報を見ない",
    aiHypeLabel: "AI驚き屋を隠す（日本・全世界）",
  ...
  en: {
    ...
    disasterLabel: "Don't show disaster & rescue info",
    foodLabel: "Don't show food & gourmet",
    aiHypeLabel: "Hide AI alarmists (Japan & worldwide)",
