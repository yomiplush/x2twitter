const X2T_I18N = {
  ja: {
    ...
    gentleLabel: "優しいモード（DoomScrolling回避）",
    customLabel: "カスタムカラー",
    colorTop: "背景（上）",
    colorBottom: "背景（下）",
    colorAccent: "鳥の色",
    ...
    strengthLabel: "フィルター強度",
    strengthWeak: "弱",
    strengthStandard: "標準",
    strengthStrong: "強",
    diagRun: "自己診断（日本語 / English）",
    diagPass: "合格 {p}/{t}（{pct}%）",
    diagFail: "要確認 {p}/{t}（{pct}%）",
    diagNote: "サンプル投稿で判定を自己採点します。外部APIは使いません",
  ...
  en: {
    ...
    gentleLabel: "Gentle mode (anti-doomscroll)",
    ...
    diagRun: "Self-check (Japanese / English)",
    diagPass: "Passed {p}/{t} ({pct}%)",
    diagFail: "Needs review {p}/{t} ({pct}%)",
    diagNote: "Scores the filter on built-in sample posts. No API is used",
